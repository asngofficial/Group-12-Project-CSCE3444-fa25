...
import { createPuzzle } from "../lib/hybridAccountManager";
...
export function CreatePage({ onNavigate, currentPage }: CreatePageProps) {
  ...
  const handlePublish = async () => {
    ...
    setError(null);
    try {
      await createPuzzle(puzzleTitle, difficulty, grid);
      ...
      toast.error(`Failed to publish puzzle: ${errorMessage}`);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="flex-1 pb-20 overflow-auto">
        <div className="p-4 space-y-4">
          ...
          <Button 
            ...
            disabled={!puzzleTitle || isLoading}
          >
            {isLoading ? (
            ...
            {isLoading ? 'Publishing...' : 'Publish Puzzle'}
          </Button>
